...
| `src/import-linter.js` | Walks the import graph for `xsl:import`/`xsl:include` cycles (`circular-import`, an error) and the same module imported twice in one stylesheet (`redundant-import`, a warning) |
